<template>
  <div>
    ...
    <b-form @submit="onSubmit" @reset="onReset" v-if="show">
      ...
      <b-form-group id="input-group-3" label="ห้องภายในตึก:" label-for="input-3">
        <b-form-select
          id="input-3"
          v-model="form.rooms"
          :options="rooms"
        ...
        ></b-form-select>
         ...
         <b-button type="submit" variant="primary" class="float-xl-right" style="margin-left:10px" to="/editBuildingSuccess">ยืนยัน</b-button>
