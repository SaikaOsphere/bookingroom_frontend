  ...
  <div>
    ...
    <div>
      ...
      <div>
        ...
        |
        <router-link to="/editBuildingSuccess"
          >Edit Building Success</router-link
        >
        |
        <router-link to="/deleteBuildingSuccess"
          >Delete Building Success</router-link
        >
      </div>
      <div>
        <router-link to="/manageRoom">RoomManagement</router-link> |
        <router-link to="/AddRoomManagement">AddRoomManagement</router-link> |
        <router-link to="/AddRoomManagementSuccess"
          >AddRoomManagementSuccess</router-link
        >
        |
        <router-link to="/EditRoomManagement">EditRoomManagement</router-link>
        |
        <router-link to="/EditRoomManagementSuccess"
          >EditRoomManagementSuccess</router-link
        >
        |
        <router-link to="/DeleteRoomManagement"
          >DeleteRoomManagement</router-link
        >
        |
        <router-link to="/DeleteRoomManagementSuccess"
